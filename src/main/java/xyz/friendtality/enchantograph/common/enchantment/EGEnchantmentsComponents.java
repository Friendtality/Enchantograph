...
public class EGEnchantmentsComponents {
    public static DeferredRegister<MapCodec<? extends EnchantmentEntityEffect>> ENCH_ENCH_EFFECTS =
            DeferredRegister.create(Registries.ENCHANTMENT_ENTITY_EFFECT_TYPE, Enchatograph.MODID);
    ...
    public static final Supplier<MapCodec<? extends EnchantmentEntityEffect>> PROPEL =
            ENCH_ENCH_EFFECTS.register("propel", ()-> PropelOnKeyEffect.CODEC);
